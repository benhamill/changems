...
CONTENT
  ...
  it "renders rdoc" do
    note_lis = find('#0_1_0 .changes ul').all('li').to_enum

    note_li = note_lis.next
    note_li.find('p').should have_content("Added direct access to NoneSuch::Collider.")
    note_li.find('p code').should have_content("NoneSuch::Collider")
  end
end
